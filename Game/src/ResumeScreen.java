...
public class ResumeScreen extends ScreenAdapter {
    ...
    public ResumeScreen(TankWars game) {
        this.game = game;
    }
    ...
    public void show() {
        ...
        Label label = new Label("Saved Games", new Label.LabelStyle(font, Color.ORANGE));
...
//        label.setFillParent(true);
        ...
        Button1 = new TextButton("Game 1",buttonSkin);
        Button1.setSize(100,100);
        Button2 = new TextButton("Game 2",buttonSkin);
        Button2.setSize(100,100);
        Button3 = new TextButton("Game 3",buttonSkin);
        ...
        Button1.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                ...
                try {
                    in = new ObjectInputStream(new FileInputStream("out1.txt"));
                    game1 = (TankWars) in.readObject();
                    in.close();
                } catch (IOException | ClassNotFoundException e) {
                    throw new RuntimeException(e);
                }
                game.player1Name = game1.player1Name;
                game.player2Name = game1.player2Name;
                game.tankChosen1 = game1.tankChosen1;
                game.tankChosen2 = game1.tankChosen2;
                game.referenceHealth1 = game1.referenceHealth1;
                game.referenceHealth2 = game1.referenceHealth2;
                game.referencePos1 = game1.referencePos1;
                game.referencePos2 = game1.referencePos2;
                game.posTank1 = game1.posTank1;
                game.posTank2 = game1.posTank2;
                game.healthTank1 = game1.healthTank1;
                game.healthTank2 = game1.healthTank2;
                game.tankturn = game1.tankturn;
        ...
        Button3.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                ObjectInputStream in = null;
                try {
                    in = new ObjectInputStream(new FileInputStream("out3.txt"));
                    game1 = (TankWars) in.readObject();
                    in.close();
                } catch (IOException | ClassNotFoundException e) {
                    throw new RuntimeException(e);
