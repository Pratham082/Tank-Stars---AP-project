...
public class ChooseScreen_2 extends ScreenAdapter {
    ...
    public ChooseScreen_2(TankWars game) {
        this.game = game;
    }
...
//        stage = new Stage(new ScreenViewport());
        ...
        label = new Label("Enter Player2 Name: ", new Label.LabelStyle(font, Color.ORANGE));
